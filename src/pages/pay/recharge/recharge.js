                ...
                sandBox.post({
                    ...
                    if (res.status) {
                        if (res.data && (res.data.type == 'balance' || res.data.type == 'point' || res.data.type == 'balance_point')) {
                            // 直接跳转到支付成功页面
                            wx.redirectTo({
                                url: '/pages/pay/success/main?order_no=' + res.data.order_no + '&formId=' + this.data.formId
                            })
                        } else {
                            this.setData({
                                merOrderId: res.data.merOrderId
            ...
            wx.requestPayment({
                ...
                success: res => {
                    if (res.errMsg == 'requestPayment:ok') {
                        ...
                        wx.hideLoading();
                        wx.redirectTo({
                            url: '/pages/pay/success/main?order_no='+this.data.merOrderId + '&type=' + type + '&formId=' + this.data.formId
                        })
                    } else {
                        console.log(res);
                        wx.showModal({
